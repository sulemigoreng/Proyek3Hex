				...
				<form id="form-id" onsubmit="return false">
						...
						<input type="hidden" id="userId" name="userId">
								...
								<div class="modal-header" align="center">
									<h4 class="modal-title">HISTORY LOAN TRANSACTION</h4>
								</div>
													...
													<table class="table table-bordered table-hover">
														<thead>
															<tr>
																...
																<th class="text-center" valign="middle" style="width: 10%">Book Title</th>
																<th class="text-center" valign="middle" style="width: 10%">Book Author</th>
																<th class="text-center" valign="middle" style="width: 10%">Publisher</th>
																<th class="text-center" valign="middle" style="width: 10%">Publication Year</th>
...
function doDetail(id){
	window.location="${pageContext.request.contextPath}/loanInfo?loanNo="+id;
}
