...
<!--             </a> -->
          ...
          <li class="dropdown user user-menu">
            <a href="${pageContext.request.contextPath}/login" class="dropdown-toggle">
       			<span style="font-size:15px; color:#000" >LOGIN</span>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel" style="background-color:#435468">
        <div class="user-header" align="center">
          <img src="${pageContext.request.contextPath}/assets/dist/img/pp/<%=pp%>" width="200" height="200" >
        </div>
...
<!--       <li class="header">NAVIGASI UTAMA</li> -->
          ...
          <a href="${pageContext.request.contextPath}/">
            <i class="fa fa-dashboard"></i> <span>KATALOG</span>
          </a>
        </li>
      </ul>
    </section>
    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" id="btn-modal" name="btn-modal"><i class="glyphicon glyphicon-ok"></i> Ya</button>
