...
public class GetDataByNameMajorLoanDateTest {
  ...
  public void testGetDataByNameMajorLoanDate() throws Exception {
    ...
    driver.findElement(By.xpath("//li[@id='BFB20000']/a/span[2]")).click();
	...
	String nameToBeFound = driver.findElement(By.id("memberName")).getAttribute("value");
	String nameFound = driver.findElement(By.xpath("//tbody[@id='tb-body-book']/tr/td[4]")).getText();

	assertEquals(nameToBeFound, nameFound);
