...
public class SearchNoFieldTest {
  ...
  @Test
  public void testSearchNoField() throws Exception {
    ...
    assertEquals("MSTD0120AINF : Data berhasil ditampilkan.", driver.findElement(By.xpath("//div[@id='toast-container']/div/div")).getText());
  }
