...
public class FR09SearchMajorYangTidakAdaPadaListTest {
  ...
  @Test
  public void testFR09SearchMajorYangTidakAdaPadaList() throws Exception {
    ...
    driver.findElement(By.id("majors")).sendKeys("Teknik Mesin");
    driver.findElement(By.xpath("//form[@id='form-id']/div[2]/div[3]/div")).click();
    driver.findElement(By.id("btnSearch")).click();
    try {
      assertEquals("Data Not Found", driver.findElement(By.id("toast-container")).getText());
    } catch (Error e) {
